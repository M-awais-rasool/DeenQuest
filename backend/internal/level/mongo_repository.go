...
func (r *MongoRepository) levelsSnapshot(ctx context.Context) ([]Level, error) {
	r.staticMu.RLock()
	if r.levelsLoaded {
...
func (r *MongoRepository) SeedLevels(ctx context.Context, levels []Level) error {
	if len(levels) == 0 {
		return nil
	}
...
func (r *MongoRepository) ReplaceLevels(ctx context.Context, levels []Level, version int) error {
	if len(levels) == 0 {
...
func (r *MongoRepository) ListAllLevels(ctx context.Context) ([]Level, error) {
...
func (r *MongoRepository) CreateLevel(ctx context.Context, level *Level) error {
...
func (r *MongoRepository) UpdateLevel(ctx context.Context, level *Level) error {
	normalizeLevelDefaults(level)
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
...
func (r *MongoRepository) ListLevelsByCourse(ctx context.Context, courseType CourseType) ([]Level, error) {
	levels, err := r.levelsSnapshot(ctx)
	if err != nil {
		return nil, err
	}
...
func (r *MongoRepository) GetLevelByID(ctx context.Context, levelID int) (*Level, error) {
	levels, err := r.levelsSnapshot(ctx)
	if err != nil {
		return nil, err
	}
...
func (r *MongoRepository) GetNextLevelByCourseLevel(ctx context.Context, courseType CourseType, courseLevel int) (*Level, error) {
	levels, err := r.levelsSnapshot(ctx)
	if err != nil {
		return nil, err
	}
...
func (r *MongoRepository) GetUserLevels(ctx context.Context, userID string) ([]UserLevel, error) {
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
...
func (r *MongoRepository) GetUserLevelsByLevelIDs(ctx context.Context, userID string, levelIDs []int) ([]UserLevel, error) {
	if len(levelIDs) == 0 {
...
func (r *MongoRepository) GetUserLevel(ctx context.Context, userID string, levelID int) (*UserLevel, error) {
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
	var ul UserLevel
...
func (r *MongoRepository) UpsertUserLevel(ctx context.Context, ul *UserLevel) error {
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
