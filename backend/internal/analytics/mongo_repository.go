...
func (r *MongoRepository) GetAdminAnalytics(ctx context.Context) (*AdminAnalytics, error) {
	r.mu.Lock()
...
func (r *MongoRepository) activitySeries(ctx context.Context, start time.Time, startStr string) []AnalyticsTimePoint {
...
func (r *MongoRepository) levelsByDifficulty(ctx context.Context) []AnalyticsLabelCount {
...
func (r *MongoRepository) topLevels(ctx context.Context) []AnalyticsLabelCount {
