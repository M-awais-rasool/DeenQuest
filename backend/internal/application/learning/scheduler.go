...
func NewScheduler(repo domain.Repository, recommender *RecommenderService) *Scheduler {
	return &Scheduler{
		cron:        cron.New(),
		repo:        repo,
...
func (s *Scheduler) sweep(ctx context.Context) {
	...
	for {
		...
		for i := range states {
			...
			if st.Segment == domain.SegmentInactive && prevSeg != domain.SegmentInactive && s.notifier != nil {
