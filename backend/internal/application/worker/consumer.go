...
import (
	...
	notifsvc "github.com/chawais/talent-flow/backend/internal/application/notification"
...
type Consumer struct {
	...
	notificationService *notifsvc.Service
}

func NewConsumer(jobRepo *persistence.JobLogRepository, notificationService *notifsvc.Service) *Consumer {
