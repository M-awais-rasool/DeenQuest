...
func (r *MongoRepository) rewardsSnapshot(ctx context.Context) ([]domain.Reward, error) {
	r.staticMu.RLock()
	if r.rewardsLoaded {
...
func (r *MongoRepository) SeedRewards(ctx context.Context, rewards []domain.Reward) error {
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
...
func (r *MongoRepository) ListAllRewards(ctx context.Context) ([]domain.Reward, error) {
	return r.rewardsSnapshot(ctx)
}

func (r *MongoRepository) GetRewardByID(ctx context.Context, id string) (*domain.Reward, error) {
...
func (r *MongoRepository) CreateReward(ctx context.Context, reward *domain.Reward) error {
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
...
func (r *MongoRepository) UpdateReward(ctx context.Context, reward *domain.Reward) error {
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
...
func (r *MongoRepository) GetUserRewards(ctx context.Context, userID string) ([]domain.UserReward, error) {
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
	...
	defer cur.Close(ctx)
	out := make([]domain.UserReward, 0, 10)
	for cur.Next(ctx) {
		var ur domain.UserReward
...
func (r *MongoRepository) GrantUserReward(ctx context.Context, ur *domain.UserReward) error {
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
