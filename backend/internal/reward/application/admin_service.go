...
func (s *Service) AdminList(ctx context.Context) ([]domain.Reward, error) {
	return s.repo.ListAllRewards(ctx)
}

func (s *Service) AdminGet(ctx context.Context, id string) (*domain.Reward, error) {
...
func (s *Service) AdminCreate(ctx context.Context, in *domain.Reward) (*domain.Reward, error) {
...
func (s *Service) AdminUpdate(ctx context.Context, id string, in *domain.Reward) (*domain.Reward, error) {
	if in == nil || strings.TrimSpace(in.Title) == "" {
		return nil, errors.New("title is required")
	}
	in.ID = id
