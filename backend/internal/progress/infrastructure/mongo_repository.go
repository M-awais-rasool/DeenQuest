...
func (r *MongoRepository) GetProgress(ctx context.Context, userID string) (*domain.Progress, error) {
...
func (r *MongoRepository) IncrementProgress(ctx context.Context, userID string, xpDelta, barakahDelta int) (*domain.Progress, error) {
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
...
func (r *MongoRepository) ListLeaderboardProgress(ctx context.Context, limit int) ([]domain.Progress, error) {
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
...
func (r *MongoRepository) GetStreak(ctx context.Context, userID string) (*domain.Streak, error) {
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
	var s domain.Streak
...
func (r *MongoRepository) UpsertStreak(ctx context.Context, streak *domain.Streak) error {
	timeoutCtx, cancel := withTimeout(ctx)
	defer cancel()
