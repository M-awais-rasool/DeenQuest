...
func TestAdvanceStreak_FirstCompletion(t *testing.T) {
	got := advanceStreak(domain.Streak{}, day(2026, 6, 20))
...
func TestAdvanceStreak_ConsecutiveDay(t *testing.T) {
	prev := domain.Streak{CurrentStreak: 3, LongestStreak: 3, LastCompletedAt: day(2026, 6, 19)}
...
func TestAdvanceStreak_SameDayNoChange(t *testing.T) {
	prev := domain.Streak{CurrentStreak: 4, LastCompletedAt: day(2026, 6, 20)}
...
func TestAdvanceStreak_GapResetsWithoutFreeze(t *testing.T) {
	...
	prev := domain.Streak{CurrentStreak: 5, LongestStreak: 5, Freezes: 0, LastCompletedAt: day(2026, 6, 18)}
	got := advanceStreak(prev, day(2026, 6, 20))
...
func TestAdvanceStreak_FreezeProtectsGap(t *testing.T) {
	...
	prev := domain.Streak{CurrentStreak: 5, LongestStreak: 5, Freezes: 1, LastCompletedAt: day(2026, 6, 18)}
	got := advanceStreak(prev, day(2026, 6, 20))
...
func TestAdvanceStreak_EarnsFreezeAtMilestone(t *testing.T) {
	...
	prev := domain.Streak{CurrentStreak: 6, LongestStreak: 6, Freezes: 0, LastCompletedAt: day(2026, 6, 19)}
	got := advanceStreak(prev, day(2026, 6, 20))
...
func TestAdvanceStreak_FreezeCap(t *testing.T) {
	...
	prev := domain.Streak{CurrentStreak: 13, LongestStreak: 13, Freezes: maxStreakFreezes, LastCompletedAt: day(2026, 6, 19)}
