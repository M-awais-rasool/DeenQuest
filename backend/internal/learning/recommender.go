...
func NewRecommenderService(learningRepo model.Repository, progressRepo progress.CoreRepository) *RecommenderService {
...
func (s *RecommenderService) State(ctx context.Context, userID string) (*model.LearnerState, error) {
	return s.learningRepo.GetState(ctx, userID)
}

// Stats returns the admin monitoring read-model.
func (s *RecommenderService) Stats(ctx context.Context) (*model.AgentStats, error) {
...
func (s *RecommenderService) Review(ctx context.Context, userID string) ([]model.Recommendation, error) {
...
func (s *RecommenderService) Get(ctx context.Context, userID string) ([]model.Recommendation, error) {
...
func (s *RecommenderService) Refresh(ctx context.Context, userID string) ([]model.Recommendation, error) {
	state, err := s.learningRepo.GetState(ctx, userID)
	if err != nil {
		return nil, err
	}
...
func (s *RecommenderService) refreshFrom(ctx context.Context, state *model.LearnerState) ([]model.Recommendation, error) {
