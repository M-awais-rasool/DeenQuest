...
type LevelSource interface {
	LevelByID(ctx context.Context, levelID int) (*level.Level, error)
}
...
func NewService(repo Repository, whisperURL string, levels LevelSource, progressSvc *progress.Service) *Service {
	return &Service{
		repo:       repo,
		levels:     levels,
...
func (s *Service) buildCoaching(ctx context.Context, score int, words []WordResult) *RecitationCoaching {
	var focus []string
...
func extractArabicText(lesson level.Lesson) (string, error) {
...
func extractLessonXP(lesson level.Lesson) int {
