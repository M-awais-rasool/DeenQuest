...
func (s *Service) AdminList(ctx context.Context) ([]DailyTask, error) {
	return s.repo.ListAllDailyTasks(ctx)
}

func (s *Service) AdminGet(ctx context.Context, id string) (*DailyTask, error) {
...
func (s *Service) AdminCreate(ctx context.Context, in *DailyTask) (*DailyTask, error) {
...
func (s *Service) AdminUpdate(ctx context.Context, id string, in *DailyTask) (*DailyTask, error) {
	if err := validateTask(in); err != nil {
		return nil, err
	}
	in.ID = id
