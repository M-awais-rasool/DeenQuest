...
import { Search, Flame, Verified, BookOpen, Lock, Play, Bookmark } from "lucide-react-native"
    ...
    <ScreenWrapper>
      <View style={styles.topBar}>
        ...
        <View style={styles.streakBadge}>
          <Flame size={20} color={theme.colors.secondary} fill={theme.colors.secondary} />
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.searchSection}>
          ...
          <View style={styles.filterRow}>
            <TouchableOpacity style={[styles.filterChip, styles.activeFilterChip]}>
              <Text style={[styles.filterChipText, styles.activeFilterChipText]}>All Surahs</Text>
            </TouchableOpacity>
        ...
        <View style={styles.surahGrid}>
          {SURAHS.map((surah) => (
            <TouchableOpacity
              key={surah.id}
              style={[styles.surahCard, surah.status === "locked" && styles.lockedSurahCard]}
            >
              {surah.status === "completed" && (
                <View style={styles.statusIcon}>
                  <Verified size={20} color={theme.colors.primary} fill={theme.colors.primary} />
                </View>
              )}
              {surah.status === "locked" && (
                <View style={styles.statusIcon}>
              ...
              <View style={styles.surahHeader}>
                <View style={styles.surahInfo}>
                  <View
                    style={[
                      styles.surahNumber,
                      surah.status === "completed" ? styles.completedNumber : styles.defaultNumber,
                    ]}
                  >
                    <Text
                      style={[
                ...
                <View style={styles.arabicSection}>
                  <Text
                    style={[
                      styles.arabicText,
                      surah.status === "completed" ? styles.completedArabic : styles.defaultArabic,
                    ]}
                  >
                    {surah.arabic}
                  </Text>
              ...
              <View style={styles.progressSection}>
                <View style={styles.progressLabels}>
                  ...
                  <Text style={styles.progressPercentage}>{Math.round(surah.progress * 100)}%</Text>
                </View>
                <ProgressBar
        ...
        <View style={styles.featuredSection}>
          <TouchableOpacity style={styles.reflectionCard}>
            ...
            <Text style={styles.reflectionSub}>
              "Then which of the favors of your Lord will you deny?" Explore the beauty of creation.
            </Text>
          ...
          <View style={styles.statsCard}>
            ...
            <View style={styles.statsTip}>
              ...
              <Text style={styles.tipText}>
                Keep going! You're 3 ayahs away from completing Al-Baqarah's current section.
              </Text>
            </View>
          </View>
        </View>
      ...
      <TouchableOpacity style={styles.bookmarkFab}>
        <Bookmark size={24} color={theme.colors.onSecondary} fill={theme.colors.onSecondary} />
      </TouchableOpacity>
    </ScreenWrapper>
  )
}
