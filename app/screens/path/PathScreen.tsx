...
import { Flame, Building, Lock, Book, Heart, Sparkles, Bolt } from "lucide-react-native"
    ...
    <ScreenWrapper>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.pathContainer}>
          ...
          {/* Level 1: Active */}
          <View style={[styles.nodeContainer, { transform: [{ translateX: -48 }] }]}>
            ...
            <TouchableOpacity style={styles.activeNode} onPress={() => {}}>
              <Building size={40} color={theme.colors.onPrimary} fill={theme.colors.onPrimary} />
          ...
          {/* Level 2: Locked */}
          <View style={[styles.nodeContainer, { transform: [{ translateX: 64 }] }]}>
            ...
            <View style={styles.lockedNode}>
              ...
              <View style={styles.lockedIconBadge}>
                <Book size={14} color={theme.colors.onSecondary} fill={theme.colors.onSecondary} />
              </View>
            </View>
          </View>

          {/* Level 3: Locked */}
          <View style={[styles.nodeContainer, { transform: [{ translateX: -40 }] }]}>
            <Text style={styles.lockedNodeTitle}>Character & Akhlaq</Text>
            <View style={styles.lockedNode}>
              <Lock size={32} color={theme.colors.textMuted} />
              <View style={styles.lockedIconBadge}>
                <Heart size={14} color={theme.colors.onSecondary} fill={theme.colors.onSecondary} />
              </View>
            </View>
          </View>
          ...
          <View style={styles.horizonCard}>
            <View style={styles.horizonInfo}>
              ...
              <Text style={styles.horizonSub}>
                Complete your current level to unlock deeper knowledge and exclusive rewards.
              </Text>
      ...
      <TouchableOpacity style={styles.fab}>
        <Bolt size={32} color={theme.colors.onSecondary} fill={theme.colors.onSecondary} />
      </TouchableOpacity>
    </ScreenWrapper>
  )
}
