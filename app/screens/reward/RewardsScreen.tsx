...
import { Trophy, Star, Lock, Verified, Flame, Sparkles, ChevronRight } from "lucide-react-native"
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <TouchableOpacity style={styles.featuredTrophy}>
          ...
          <View style={styles.trophyIconContainer}>
            <Trophy size={64} color={theme.colors.secondary} fill={theme.colors.secondary} />
          </View>
          <Text style={styles.featuredTitle}>Master of Consistency</Text>
          <Text style={styles.featuredSub}>You're in the top 5% of users this month!</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.trophyGrid}>
            {TROPHIES.map((trophy) => (
              <TouchableOpacity
                key={trophy.id}
                style={[styles.trophyCard, trophy.status === "locked" && styles.lockedCard]}
              >
                <View style={styles.trophyHeader}>
                  <View
                    style={[
                      styles.iconCircle,
                      trophy.status === "unlocked" ? styles.unlockedCircle : styles.lockedCircle,
                    ]}
                  >
