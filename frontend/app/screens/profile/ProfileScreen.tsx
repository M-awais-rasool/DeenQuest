...
export function ProfileScreen() {
  ...
  const achievements = [
    { icon: <Sparkles color="#FFDB3C" size={32} />, label: "First Khatm", locked: false },
    { icon: <Moon color="#88D982" size={32} />, label: "Tahajjud Warrior", locked: false },
    { icon: <HandHeart color="#F472B6" size={32} />, label: "Giver", locked: false },
  ...
  return (
    <ScreenWrapper>
      ...
      <Header title="DEENQUEST" xp={1250} Icon={Settings} onSettingsPress={() => {}} />
      ...
      >
        ...
        <View style={styles.statsGrid}>
          <View style={styles.statCard}>
            <Trophy color="rgba(255,255,255,0.05)" size={80} style={styles.bgIcon} />
          ...
          <View style={styles.statCard}>
            <Heart color="rgba(255,255,255,0.05)" size={80} style={styles.bgIcon} />
          ...
          <View style={styles.streakCard}>
            <View style={styles.streakHeader}>
              <View>
                ...
                <Text style={styles.sectionSubtext}>Your consistency this month</Text>
              </View>
            ...
            <View style={styles.daysGrid}>
              {streakDays.map((day, i) => (
                <View key={i} style={styles.dayColumn}>
                  ...
                  >
                    {completedDays[i] === true && <Check color="#003909" size={16} />}
          ...
          <View style={styles.goalCardContainer}>
            <View style={[styles.goalCard, { borderLeftColor: "#88D982" }]}>
              <View style={styles.goalHeader}>
                ...
                <Text style={[styles.goalPercent, { color: "#88D982" }]}>80%</Text>
              </View>
              <View style={styles.progressBarBg}>
                <View
                  style={[styles.progressBarFill, { width: "80%", backgroundColor: "#88D982" }]}
                />
              </View>
            </View>
            ...
            <View style={[styles.goalCard, { borderLeftColor: "#FFDB3C" }]}>
              <View style={styles.goalHeader}>
                ...
                <Text style={[styles.goalPercent, { color: "#FFDB3C" }]}>12/30</Text>
              </View>
              <View style={styles.progressBarBg}>
                <View
                  style={[styles.progressBarFill, { width: "40%", backgroundColor: "#FFDB3C" }]}
                />
              </View>
            </View>
          </View>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.badgeScroll}>
          {achievements.map((ach, i) => (
            <View key={i} style={[styles.badgeItem, ach.locked && { opacity: 0.3 }]}>
              <View
                style={[
