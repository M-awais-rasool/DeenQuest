      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.summaryCard}>
          <View style={styles.summaryHeader}>
            <View style={styles.barakahBadge}>
              <Sparkles size={16} color={theme.colors.secondary} fill={theme.colors.secondary} />
        ...
        <View style={styles.section}>
          ...
          <View style={styles.prayerGrid}>
            {(Object.keys(prayers) as Array<keyof typeof prayers>).map((prayer) => (
              <TouchableOpacity
                key={prayer}
                style={[styles.prayerCard, prayers[prayer] && styles.activePrayerCard]}
                onPress={() => togglePrayer(prayer)}
              >
                <Text style={[styles.prayerName, prayers[prayer] && styles.activePrayerName]}>
                  {String(prayer).charAt(0).toUpperCase() + String(prayer).slice(1)}
                </Text>
                {prayers[prayer] ? (
                  <CheckCircle2
                    size={24}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.habitList}>
            <View style={styles.habitItem}>
              <View style={[styles.habitIcon, { backgroundColor: "rgba(255, 219, 60, 0.1)" }]}>
              ...
              <Switch
                ...
                trackColor={{ false: theme.colors.surfaceHigh, true: theme.colors.primary }}
                thumbColor={habits.quran ? theme.colors.text : theme.colors.textMuted}
              />
            </View>

            <View style={styles.habitItem}>
              <View style={[styles.habitIcon, { backgroundColor: "rgba(255, 177, 199, 0.1)" }]}>
              ...
              <Switch
                ...
                trackColor={{ false: theme.colors.surfaceHigh, true: theme.colors.primary }}
                thumbColor={habits.helped ? theme.colors.text : theme.colors.textMuted}
              />
            </View>

            <View style={styles.habitItem}>
              <View style={[styles.habitIcon, { backgroundColor: "rgba(136, 217, 130, 0.1)" }]}>
              ...
              <Switch
                ...
                trackColor={{ false: theme.colors.surfaceHigh, true: theme.colors.primary }}
                thumbColor={habits.dhikr ? theme.colors.text : theme.colors.textMuted}
              />
            </View>
          </View>
        </View>
        ...
        <TouchableOpacity style={styles.journalCard}>
          ...
          <View style={styles.journalInputPlaceholder}>
            <Text style={styles.placeholderText}>Tap to write your reflection...</Text>
          </View>
        </TouchableOpacity>

        <TactileButton title="Save Reflection" onPress={() => {}} style={styles.saveButton} />
      </ScrollView>
    </ScreenWrapper>
  )
}
