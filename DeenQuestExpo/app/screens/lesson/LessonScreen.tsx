      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.heroSection}>
          ...
          <Text style={styles.description}>
            Learn the essential spiritual and physical components that make your
            Salah valid and meaningful.
          </Text>
        </View>
        ...
        <View style={styles.interactivePreview}>
          ...
          <Text style={styles.previewText}>
            Listen to the correct pronunciation of the opening Takbir with
            phonetic highlights.
          </Text>
