...
export default function ContentEditorPage() {
  ...
  const [type, setType] = useState<ContentType>(
    (searchParams.get("type") as ContentType) || "task",
  );
  ...
  const difficultyOptions = useMemo(
    () => (isTask ? TASK_DIFFICULTIES : LEVEL_DIFFICULTIES),
    [isTask],
  );
  const componentOptions = useMemo(
    () =>
      isTask
        ? TASK_COMPONENTS.map((c) => ({
            ...c,
            description: `${c.description} (${c.screen})`,
          }))
        : LESSON_COMPONENTS.map((c) => ({
            ...c,
            description: `${c.description} (${c.types.join(", ")})`,
          })),
    [isTask],
  );
          ...
          <section className="glass-card p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <SelectField
                ...
                placeholder="How the task is completed..."
              />
            </div>
          </section>
        )}
          ...
          <section className="glass-card p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <SelectField
                ...
                value={theme}
                onChange={setTheme}
                options={LEVEL_THEMES}
                placeholder="Select level theme..."
              />
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-white/50 mb-1.5">
                  Goal Description
                ...
                <input
                  ...
                  placeholder="What the student will achieve in this level..."
                />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="salah, beginner, morning"
              />
            </div>
          </div>
        </section>
        ...
        <section className="glass-card p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div key={field}>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      value={
                        ((style as Record<string, unknown>)[field] as string) ||
                        defaults[field]
                      }
                      onChange={(e) =>
                        setStyle({ ...style, [field]: e.target.value })
                      }
                    />
                    <input
            ...
            <SelectField
              ...
              onChange={(v) => setStyle({ ...style, font_family: v })}
            ...
            <div>
              ...
              <input
                ...
                value={style.padding ?? ""}
                onChange={(e) =>
                  setStyle({ ...style, padding: parseInt(e.target.value) || 0 })
                }
                placeholder="16"
              />
            </div>
