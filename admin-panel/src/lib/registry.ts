...
export const SCREEN_TYPES = [
  {
    value: "CHECKLIST",
    label: "Checklist",
    description: "Step-by-step prayer/action checklist",
    icon: "✅",
  },
  {
    value: "QURAN_READER",
    label: "Quran Reader",
    description: "Ayah-by-ayah Quran reading screen",
    icon: "📖",
  },
  {
    value: "COUNTER",
    label: "Counter",
    description: "Tap-to-count dhikr screen",
    icon: "🔢",
  },
  {
    value: "HADITH_CARD",
    label: "Hadith Card",
    description: "Hadith display with source",
    icon: "📜",
  },
  {
    value: "QUIZ",
    label: "Quiz",
    description: "Multiple-choice quiz screen",
    icon: "❓",
  },
  {
    value: "AUDIO_PLAYER",
    label: "Audio Player",
    description: "Audio playback screen",
    icon: "🔊",
  },
  {
    value: "REFLECTION",
    label: "Reflection",
    description: "Journaling / reflection prompt",
    icon: "💭",
  },
  {
    value: "TIPS",
    label: "Tips",
    description: "Informational tips card",
    icon: "💡",
  },
  {
    value: "ACTION",
    label: "Action",
    description: "Simple action completion screen",
    icon: "⚡",
  },
] as const;
...
export const COMPLETION_TYPES = [
  ...
  { value: "auto", label: "Auto", description: "Auto-complete on interaction" },
  {
    value: "counter",
    label: "Counter",
    description: "Complete after reaching target count",
  },
  {
    value: "quiz",
    label: "Quiz",
    description: "Complete after answering correctly",
  },
] as const;
...
export const LESSON_TYPES = [
  {
    value: "qaida",
    label: "Qaida",
    description: "Arabic alphabet / Qaida lessons",
    icon: "📖",
  },
  {
    value: "hadith",
    label: "Hadith",
    description: "Hadith learning",
    icon: "🕌",
  },
  { value: "dua", label: "Dua", description: "Dua memorization", icon: "🤲" },
  {
    value: "quiz",
    label: "Quiz",
    description: "Quiz-based lesson",
    icon: "❓",
  },
  {
    value: "pronunciation",
    label: "Pronunciation",
    description: "Arabic pronunciation practice",
    icon: "🗣️",
  },
  {
    value: "manners",
    label: "Manners",
    description: "Islamic manners & etiquette",
    icon: "🌟",
  },
  {
    value: "revision",
...
export const MINI_GAME_TYPES = [
  {
    value: "tap_match",
    label: "Tap Match",
    description: "Match Arabic to meaning by tapping",
    icon: "👆",
  },
  {
    value: "listen_choose",
    label: "Listen & Choose",
    description: "Listen to audio and pick correct answer",
    icon: "👂",
  },
  {
    value: "drag_drop",
  ...
  },
  {
    value: "repeat_voice",
    label: "Repeat Voice",
    description: "Listen and repeat pronunciation",
    icon: "🎤",
  },
  {
    value: "mcq",
...
export const BLOCK_TYPES = [
  ...
  },
  {
    value: "AyahBlock",
    label: "Ayah",
    description: "Quran ayah with Arabic + translation",
    icon: "📖",
  },
  {
    value: "HadithBlock",
  ...
  },
  {
    value: "CounterBlock",
    label: "Counter",
    description: "Tap counter with target",
    icon: "🔢",
  },
  {
    value: "QuizBlock",
  ...
  {
    value: "ChecklistBlock",
    label: "Checklist",
    description: "Interactive checklist items",
    icon: "✅",
  },
  {
    value: "FlashCardBlock",
    label: "Flash Card",
...
export const TASK_COMPONENTS = [
  {
    value: "PrayerChecklistComponent",
    label: "Prayer Checklist",
    description: "Step-by-step prayer checklist",
    screen: "CHECKLIST",
  },
  {
    value: "QuranReaderComponent",
    label: "Quran Reader",
    description: "Quran ayah reader with audio",
    screen: "QURAN_READER",
  },
  {
    value: "CounterComponent",
    label: "Counter",
    description: "Dhikr tap counter",
    screen: "COUNTER",
  },
  {
    value: "HadithComponent",
    label: "Hadith",
    description: "Hadith card display",
    screen: "HADITH_CARD",
  },
  {
    value: "QuizComponent",
  ...
  },
  {
    ...
    label: "Reflection",
    description: "Reflection journaling prompt",
    screen: "REFLECTION",
  },
  {
    value: "TipsComponent",
    label: "Tips",
    description: "Info / tips card",
    screen: "TIPS",
  },
  {
    value: "ActionComponent",
    label: "Action",
    description: "Simple action task",
    screen: "ACTION",
  },
] as const;
...
export const LESSON_COMPONENTS = [
  {
    value: "LetterIntroComponent",
    label: "Letter Intro",
    description: "Arabic letter introduction",
    types: ["qaida"],
  },
  {
    value: "LetterFormsComponent",
    label: "Letter Forms",
    description: "Arabic letter forms display",
    types: ["qaida"],
  },
  {
    value: "PronunciationComponent",
    label: "Pronunciation",
    description: "Pronunciation practice",
    types: ["pronunciation", "qaida"],
  },
  {
    value: "DuaCardComponent",
    label: "Dua Card",
    description: "Dua with Arabic + transliteration",
    types: ["dua"],
  },
  {
    value: "HadithComponent",
  ...
  },
  {
    value: "PrayerChecklistComponent",
    label: "Prayer Checklist",
    description: "Prayer steps checklist",
    types: ["revision"],
  },
  {
    value: "CertificateComponent",
    label: "Certificate",
    description: "Level completion certificate",
    types: ["revision"],
  },
] as const;
...
export const LAYOUTS = [
  {
    value: "single-column",
    label: "Single Column",
    description: "Blocks stacked vertically",
  },
  ...
  },
  {
    value: "scroll-snap",
    label: "Scroll Snap",
    description: "Snap scrolling between sections",
  },
] as const;
